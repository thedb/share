...
可以看出，vw&vh与基于外层容器的百分比%不同，它是基于window.innerWidth&window.innerHeihgt的单位。在2.1介绍的Flexible其实也是用了rem来模拟vw这个单位。有了Flexible的经验，我们是否可以直接将vw&vh运用到项目中去？
...
<img width="500px" style="display:block" src="./images/adaptation/retina-web2.jpg">
