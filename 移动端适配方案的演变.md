...
虽然还有很多我没有提到的坑，不过在现阶段，还是有很多适配方案可以选择。
...
<img width="500px" style="display:block" src="./images/retina-web3.jpg">

介绍到这里，你可能会问：这和之前使用的rem有什么区别？
...
另外，之前提到的rem转换问题我们也可以通过IDE的插件 || npm模块 || 预处理器：less & scss的函数来实现，如：

<a href="hhttps://github.com/flashlizi/cssrem">一个px值转rem值的Sublime Text 3自动完成插件</a>
...
线上案例：<a href="http://www.roger-gallet.com.cn/">香邂格蕾官网</a>
